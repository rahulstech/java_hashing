...
public class Lab1 extends DFSModule {
	@BeforeAll
	...
	@TestFactory
	@DisplayName("Create l1_table01 [s*, i, b]")
	@Order(1)
	...
	@TestFactory
	@DisplayName("Create l1_table02 [i, b, b, i*, i, b]")
	@Order(1)
	...
	@TestFactory
	@DisplayName("Create l1_table03 [s, s, s, i, i, i, b, b, b, s*, s, i, i, b, b]")
	@Order(1)
